...
###here they are named: "LIWC2015_Kafka_int.csv" (LIWC analysis of the files "Kafka_young_mean.txt" and "Kafka_old.txt"); "LIWC2015_Kafka_ext.csv" (LIWC analysis of the files "Other_authors_young_mean.txt" and "Other_authors_old.txt"), generated by the previous piece of code
...
###prepare LIWC for Kafka
LIWC <- read.csv("LIWC2015_Kafka_int.csv")
...
LIWC_Others <- read.csv("LIWC2015_Kafka_ext.csv")
...
p4
ggsave("Kafka_LIWC_analysis.png", p4, height = 6, width = 10)
