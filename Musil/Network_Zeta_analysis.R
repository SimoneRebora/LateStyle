...
oppose(gui = FALSE, primary.corpus = Musil_old, secondary.corpus = other_authors_old, text.slice.length=3000, text.slice.overlap=0, oppose.method="craig.zeta", visualization="markers")
dev.off()

png("Musil_oppose_ext_middle.png", width = 2000, height = 2000, res = 300)
oppose(gui = FALSE, primary.corpus = Musil_middle, secondary.corpus = other_authors_middle, text.slice.length=3000, text.slice.overlap=0, oppose.method="craig.zeta", visualization="markers")
dev.off()

png("Musil_oppose_ext_young.png", width = 2000, height = 2000, res = 300)
oppose(gui = FALSE, primary.corpus = Musil_young, secondary.corpus = other_authors_young, text.slice.length=3000, text.slice.overlap=0, oppose.method="craig.zeta", visualization="markers")
dev.off()